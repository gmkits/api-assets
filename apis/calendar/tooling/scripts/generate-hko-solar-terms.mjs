 ...
 *
 * Usage:
 *   node tooling/scripts/generate-hko-solar-terms.mjs
 *   node tooling/scripts/generate-hko-solar-terms.mjs --output path/to/out.csv
 */
...
const DEFAULT_OUTPUT = join(__dirname, '..', '..', 'tests', 'golden', 'solar-terms.csv');
